...
\begin{supertabular}{ll} % Start a table with two columns, the table will ensure everything is aligned
	...
	%------------------------------------------------
	\tableentry{Grade-Point Average}{3.26}{spaceafter}
...
\workposition{Current, from Jan 2019} % Duration
{} % FT/PT (full time or part time)
{University of Illinois} % Employer
{Course Assistant - Software Design Studio} % Job title
{Moderated weekly code reviews for a group of students, allowing them to learn and improve from their mistakes. Helped create content and infrastructure to aid the course. Helped students one-on-one with niche coding problems.}\\ % Description
...
\begin{supertabular}{ll} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Languages}{Python, Java, C, C++, \LaTeX}{}
	\tableentry{}{Ocaml, LISP, FSharp}{spaceafter}
	
	%------------------------------------------------
	
	\tableentry{Libraries}{OpenFrameworks, Cython,}{}
	\tableentry{}{SpaCy, TextBlob, nltk, numpy,}{}
	\tableentry{}{matplotlib, graphviz, scipy, bs4,}{}
	\tableentry{}{pygame, pyglet}{spaceafter}
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Posters}{Poster at PURE Research symposium}{}
	\tableentry {}{(May 2018)}{spaceafter}
	...
	\tableentry {}{Event Head - Mathtrix}{}
	\tableentry {}{(Mathematics festival)}{}
	\tableentry {}{(2017)}{}
	%------------------------------------------------
...
\begin{supertabular}{ll} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Creativity}{Self-taught pianist and guitarist}{}
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Email}{malisharma@gmail.com}{spaceafter}
...
%	\tableentry{}{}{} % Creates some additional whitespace between the references
	...
	\tableentry{Email}{jasonet2@illinois.edu}{spaceafter}
...
%	\tableentry{}{}{} % Creates some additional whitespace between the references
	...
	\tableentry{}{University of Illinois}{}
	\tableentry{Email}{ajschmd2@illinois.edu}{spaceafter}
