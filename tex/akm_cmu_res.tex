...
\begin{supertabular}{ll} % Start a table with two columns, the table will ensure everything is aligned
	...
	%------------------------------------------------
	\tableentry{Grade-Point Average}{3.27}{spaceafter}
...
\workposition{Jan 2019 -- May 2019, Jan 2020 --} % Duration
{PT} % FT/PT (full time or part time)
{University of Illinois} % Employer
{Course Assistant} % Job title
{Course assistant on Software Design and Numerical Methods. Leading weekly code reviews for a group of students, allowing them to learn and improve from their mistakes. Developing software and assesments for the course. Helping students one-on-one with niche coding problems.}% Description
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Publication}{\textit{Introducing} \texttt{{\href{https://peer.asee.org/introducing-junto-a-web-tool-to-build-project-teams-based-on-a-bidding-strategy}{junto}}} \textit{, a Web Tool to Build}}{}
	\tableentry{}{\textit{Project Teams based on a Bidding Strategy}}{}
	\tableentry {}{American Society for Engineering Education}{}
	\tableentry {}{2020}{}
	\tableentry{Poster}{Poster at PURE Research symposium}{}
...
\begin{supertabular}{ll} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Languages}{Python, C, Bash, Java, C++, \LaTeX}{}
	\tableentry{}{Ocaml, LISP, FSharp, Javascript}{spaceafter}
	
	%------------------------------------------------
	
	\tableentry{Libraries}{Flask, ExpressJs, OpenFrameworks,}{}
	\tableentry{}{Cython, multiprocessing, threading,}{}
	\tableentry{}{pytorch, SpaCy, TextBlob, nltk, bs4,}{}
	\tableentry{}{matplotlib, graphviz, scipy, numpy}{spaceafter}

	\tableentry{Software}{{Apache Hadoop, Solr, Spark, Hive,}}{}
	\tableentry{}{Docker, MySQL}{spaceafter}
